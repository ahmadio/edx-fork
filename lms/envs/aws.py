...
# PLATFORM_NAME = ENV_TOKENS.get('PLATFORM_NAME', 'دارِس')
PLATFORM_NAME = u'دارِس'
...
# Stripe keys
STRIPE_KEY_PUBLIC = AUTH_TOKENS.get("STRIPE_KEY_PUBLIC", "pk_test_yrNR7N5jcsqo23tbvR8OJZeE")
STRIPE_KEY_SECRET = AUTH_TOKENS.get("STRIPE_KEY_SECRET", "sk_test_sDshP03YNn7oZlRAQUqlDxlf")
